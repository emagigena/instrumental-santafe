        ...
        <footer className="text-white py-4 bg-dark center">
          <div className="container">
            <nav className="row">
              ...
              <ul className="col-2 col-md-5 list-unstyled text-center">
              ...
              <ul className="col-12 col-md-3 list-unstyled">
                ...
                <li className='d-flex justify-content-between'>
                  <i className="bi bi-facebook"></i><li className="col-12  list-unstyled justify-content-between">Facebook: @DavidSantaFe WhatsApp:342111111</li>
                  <i className="bi bi-whatsapp"></i> 
                </li>
              </ul>
              
              <ul className="col-12 col-md-3 d-flex alling-items-center justify-content-center list-unstyled text-center">
