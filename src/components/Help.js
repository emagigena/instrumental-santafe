const productos = [
    ...
    {id: '2'  , nombre: 'GUITARRA ACUSTICA EKO RANGER FOLK 12c' , precio: 2.999, categoria: "EKO" , marca: "EKO" , stock: 17, fotos : [
    ...
    {id: '3'  , nombre: 'GUITARRA ELECTRICA DANELECTRO 59M' , precio: 3.999, categoria: "DANELECTRO" , marca: "DANELECTRO", stock: 25, fotos : [
    ...
    {id: '7'  , nombre: 'GUITARRA DANELECTRO CONVERT AC-ELEC' , precio: 3.999, categoria: "DANELECTRO" , marca: "DANELECTRO" , stock: 25, fotos : [
    ...
    {id: '9'  , nombre: 'GUITARRA ELÉCTRICA STAGG SILVERAY & RED' , precio: 3.999, categoria: "STAGG" , marca: "STAGG" , stock: 25, fotos : [
    ...
    {id: '10'  , nombre: 'GUITARRA ELECTRICA STAGG TELECASTER' , precio: 3.999, categoria: "STAGG" , marca: "STAGG" , stock: 25, fotos : [
    ...
    {id: '12' , nombre: 'GUITARRA ELECTRICA TOKAI T/LES PAUL' , precio: 3.999, categoria: "TOKAI" , marca: "TOKAI" , stock: 25, fotos : [
